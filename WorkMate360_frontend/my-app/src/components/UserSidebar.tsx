...
>
  Leave Request
          ...
          <hr className="fixed left-5 w-39 top-48 border-t border-gray-400" style={{ marginTop: '3.5rem' }} />
          <button className=' fixed left-5 w-39 top-64 p-2 rounded-2xl hover:text-lg' ><Link to={'/form'}>Change Password</Link></button>
